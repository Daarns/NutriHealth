            ...
            <div class="mb-2 align-items-center">
              <div class="card shadow mb-4">
                <div class="card-header">
                  ...
                  <a class="float-right small text-muted" href="{{ route('admin.users')}}">View all</a>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            @if($user->doctor)
                            Dokter - {{ $user->doctor->specialization }}
                            @else
                            {{ $user->role }}
                            @endif
                          </td>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="card shadow">
                  <div class="card-body">
                    <div class="col-md-12">
                      <p class="mb-0"><strong class="mb-0 text-uppercase text-muted">Stats</strong></p>
                    </div>
                    <hr class="my-o" />
                    <div class="bg-white text-sm">
                      <h4 class="px-3 py-4 op-5 m-0 roboto-bold">Forum</h4>
                      <div class="row text-center d-flex flex-row op-7 mx-0 justify-content-between">
                        <div class="col-sm-6 flex-ew text-center py-3" style="border-right: 1px solid #ccc;">
                          <a class="d-block lead font-weight-bold" href="#">{{ $totalThreads}}</a>
                          Topics
                        </div>
                        <div class="col-sm-6 col flex-ew text-center py-3">
                          <a class="d-block lead font-weight-bold" href="#">{{ $totalPosts }}</a>
                          Posts
                        </div>
                      </div>
                    </div>
                    ...
                    <table class="table table-striped table-hover table-borderless">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <form method="POST" action="{{ route('admin.removeData', ['id' => $item->id, 'type' => $item->type]) }}">
                              @csrf
                              @method('DELETE')
