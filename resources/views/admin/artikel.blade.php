                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted pr-0" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="avatar avatar-sm mt-2">
                            <img src="{{ auth()->user()->profile_picture ? asset('img/profile_pictures/' . auth()->user()->profile_picture) : asset('img/profile.png') }}" alt="" style="width: 35px; height: 35px;" />j
                        </span>
                    </a>
                                    ...
                                    <div class="row mt-1 align-items-center">
                                        <div class="col-12">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover w-100">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <a href="#" class="btn btn-primary btn-edit" data-id="{{ $article->id }}">Edit</a>
                                                                    <form action="{{ route('admin.artikel.delete', $article->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                            ...
                                                            <form id="editForm" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea class="form-control" id="content" name="content" style="width: 100%; height: 200px;"></textarea>
                                                                    </div>
                                                                    <div class="form-group">
                                                ...
                                                {{ $articles->links() }}
                                                <div class="mt-3">
                                                    <a href="{{ route('admin.artikel.create') }}" class="btn btn-success">Tambah Artikel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            $('.btn-edit').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#type').val(data.type);
                        $('#editForm').attr('action', '{{ route("admin.artikel.update", ":id") }}'.replace(':id', id));
