                            ...
                            <div class="col-12">
                                <div class="card shadow">
                                    <div class="card-header">
                                        <strong class="card-title">Post Data</strong>
                                    </div>
                                        ...
                                        <table class="table table-striped table-hover table-borderless">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $post->parent ? $post->parent->id : 'N/A' }}</td> <!-- Menampilkan ID dari post yang di-reply, atau 'N/A' jika post tersebut bukan balasan dari post lain --> <!-- Menampilkan ID dari post yang di-reply -->
                                                    <td>{{ $post->user->username }}</td>
                                                    <td>{{ $post->created_at->format('d/m/Y') }}</td>
                                                    <td>{{ $post->body }}</td> <!-- Menampilkan isi dari post -->
                                                    <td>
                                                        <form method="POST" action="{{ route('admin.removePost', ['id' => $post->id]) }}">
                                                            @csrf
                                                            @method('DELETE')
