        ...
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li>
                        <a class="nav-link scrollto active" href="#">Artikel</a>
                    </li>
                    <li>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <img class="img-fluid" src="{{ asset('images/' . $article->image_path) }}" alt="{{ $article->title }}">
                    <h1 class="section-heading">{!! $article->title !!}</h1>
                    <p>{!! $article->content !!}</p>
                    <a href="{{ url('/artikel') }}">← Kembali ke halaman Artikel</a>
                </div>
            </div>
        </div>
    </article>
