        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <img class="img-fluid" src="{{ asset('images/' . $recipe->image_path) }}" alt="{{ $recipe->title }}">
                    <h1 class="section-heading">{!! $recipe->title !!}</h1>
                    <label for="ingredients">Bahan-Bahan
                        <p id="ingredients">{!! $recipe->ingredients !!}</p>
                    </label>
                    <label for="recipe">Cara Membuat :
                        <p id="recipe">{!! $recipe->recipe !!}</p>
                    </label>
                    <a href="{{ url('/resep') }}">← Kembali ke halaman sebelumnya</a>
                </div>
            </div>
        </div>
    </article>
